...
from utils.utils import frame_stacking_legacy, onehot, load_dat, log_config, load_model, init_weight, adjust_learning_rate, spec_aug, save_hparams
from Loss.label_smoothing import label_smoothing_loss_legacy
    ...
    for i in range(num_mb):
        ...
        if hp.decoder_type == 'Attention':
            for k in range(hp.batch_size):
                ...
                loss += label_smoothing_loss_legacy(predict_ts[k, :num_labels], padded_sorted_ts_onehot_LS[k, :num_labels]) / num_labels
