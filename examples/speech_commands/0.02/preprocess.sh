...
tar -zxf speech_commands_v0.02.tar.gz -C ./feature/wav/
...
python utils/make_id_file.py -l char/training_wav_list_char.txt -v char/char_id.txt > char/training_wav_list_char_id.txt
